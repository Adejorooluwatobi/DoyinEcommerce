(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        methods: function(e) {
            ...
            axilInit.countdownInit('.coming-countdown', '2025/01/01');
            axilInit.campaignCountdown('.campaign-countdown', '2025/01/01');
            axilInit.countdownInit('.poster-countdown', '2025/01/01');
            axilInit.countdownInit('.sale-countdown', '2025/01/31');
